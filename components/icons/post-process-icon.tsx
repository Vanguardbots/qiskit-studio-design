...
export const PostProcessIcon = ({ className }: { className?: string }) => {
    return (
        <svg
            width="16"
            height="16"
        ...
        >
            ...
            <path d="M2 1H1V14C1 14.2652 1.10536 14.5196 1.29289 14.7071C1.48043 14.8946 1.73478 15 2 15H15V14H2V1Z" fill="currentColor" />
